...
那么从这个函数来看有颜色变换而且现在来看并不知道`valueTransformer`是啥，所以我们先去看一下这个函数的构造方法
...
‍![img](https://shs3.b.qianxin.com/attack_forum/2024/03/attach-2cdf3e854d83deeaeb2b06783001c5f2e46592b7.png)
...
那也就是说在put方法之后我们去把这个key给`remove`掉就好了
